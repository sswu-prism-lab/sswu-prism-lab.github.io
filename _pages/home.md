...
<div id="open-positions" class="alert" role="alert" style="margin: 20px 0; line-height: 1.6; background-color: #fafdff; border: 1px solid #e9d5ff; color: #5b21b6; border-radius: 6px;">   
  ...
  <ul style="margin-bottom: 0; padding-left: 20px;">     
    <li><strong><span class="i18n-en">Prospective Ph.D./Master Student:</span><span class="i18n-ko">박사/석사 과정 지원자:</span></strong> <del>2</del> &rarr; 1       
    ...
    <!-- 학부 인턴 파트 취소선 적용 -->
    <li><del><strong><span class="i18n-en">Undergraduate Intern: 2 (All openings have been filled.)</span><span class="i18n-ko">학부 인턴: 2 (모든 인원이 충원되었습니다.)</span></strong>
      <ul style="margin-top: 5px; margin-bottom: 0; padding-left: 20px; list-style-type: circle;">         
